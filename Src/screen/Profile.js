...
const Profile = () => {
  return (
    <View className="flex-1 bg-gray-200">
      ...
      <View>
        <Image
          source={require("./../../assets/Images/bluecard.jpg")}
      ...
      <View className="w-11/12 mx-auto relative bottom-24 h-40 rounded-lg overflow-hidden">
        ...
        <View className="ml-5 relative bottom-36">
          ...
          <View className="flex-row justify-between mr-5 mt-12 items-end">
            <Text className="text-white">Join Date:01/01/2023</Text>
            <Text className="text-xl font-semibold text-white">420 points</Text>
          </View>
        </View>
      </View>
